...
\begin{tikzcd}
     &                  \{0\}   &   & \\
\{0\} \arrow[ru,swap,"p_1"]&             & \{0\} \arrow[lu,"p_2"]&     \\
     &              \{0\} \arrow[lu,swap,"g_1"] \arrow[ru,"g_2"] \arrow[uu,dashed]       &   &               
\end{tikzcd}
\vspace*{.2cm}
...
\begin{tikzcd}
     &                  \{0,1\}   &   & \\
\{0\} \arrow[ru,swap,"p_1"]&             & \{1\} \arrow[lu,"p_2"]&     \\
     &              \{\} \arrow[lu,swap,"g_1"] \arrow[ru,"g_2"] \arrow[uu,dashed]       &   &               
\end{tikzcd}
\vspace*{.2cm}
...
\smallskip
{\centering
\boxed{a\mystrut}\boxed{b^\prime\mystrut}\boxed{c\mystrut},
\boxed{a^\prime\mystrut}\boxed{b^\prime\mystrut}\boxed{c^\prime\mystrut}
and
\boxed{a^\prime\mystrut}\boxed{b\mystrut}\boxed{c^\prime\mystrut}, \par}
\smallskip
...
} \qquad\qquad \raisebox{-.2cm}{\fontspec{Bookhands}G.\bsp H.\bsp Mead}
\end{frame}
...
\mathcal{G} \arrow[ru,swap,"p_1"]&             & \mathcal{P} \arrow[lu,"p_2"]&     \\
     &               abc? \arrow[lu,swap,"g_1"] \arrow[ru,"g_2"] \arrow[uu,dashed]       &   &               
\end{tikzcd}
\vspace*{.2cm}
