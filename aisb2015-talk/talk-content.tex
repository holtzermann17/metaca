...
a ``phenotype'', and reenvision our 1D MetaCAs as multi-dimensional?  Can {\fontspec{Bookhands}Game\bsp of\bsp Life} semantics help decide how many 1s and 0s to keep?}
\end{column}
\begin{column}[T]{.1cm}
\end{column}
\end{columns}
